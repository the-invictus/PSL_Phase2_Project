...
public class ApplicantService {
  ...
  public List<Applicant> getApplicantsByProfileId(long profile_id) {
    return applicantRepository.getApplicantsByProfileId(profile_id);
  }

  public List<Object[]> getApplicationsByProfileId(long profile_id) {
    return applicantRepository.getApplicationsByProfileId(profile_id);
  }
